...
class BaseModel:
    ...
    Methods:
        ...
        from_dict: Recreates a BaseModel instance from a dictionary representation.
    """
    ...
    def from_dict(cls, obj_dict):
        ...
        Args:
            obj_dict (dict): Dictionary representation of the BaseModel instance.

        Returns:
            BaseModel: Instance of BaseModel initialized with values from obj_dict.
        """
        # Remove the __class__ attribute if present
        obj_dict.pop('__class__', None)
